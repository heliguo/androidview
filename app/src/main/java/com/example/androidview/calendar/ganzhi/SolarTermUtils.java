...
public class SolarTermUtils {
    ...
    public static int getSolar(String solarName) {
        if (solarName.equals("立春")) {
            return 0;
        } else if (solarName.equals("惊蛰")) {
            return 1;
        } else if (solarName.equals("清明")) {
            return 2;
        } else if (solarName.equals("立夏")) {
            return 3;
        } else if (solarName.equals("芒种")) {
            return 4;
        } else if (solarName.equals("小暑")) {
            return 5;
        } else if (solarName.equals("立秋")) {
            return 6;
        } else if (solarName.equals("白露")) {
            return 7;
        } else if (solarName.equals("寒露")) {
            return 8;
        } else if (solarName.equals("立冬")) {
            return 9;
        } else if (solarName.equals("大雪")) {
            return 10;
        } else if (solarName.equals("小寒")) {
            return 11;
        }
        return -1;
    }
