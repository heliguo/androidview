...
public class LunarUtil {
    ...
    private static final String[] Gan = {"癸", "甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬"};
    private static final String[] Zhi = {"亥", "子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌"};
    private static final String[] Animals = {"猪", "鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗"};
    ...
    private static String getDayStr(int lunarDay) {
        if (lunarDay == 10) {
            return "初十";
        } else {
            int n = lunarDay % 10 == 0 ? 9 : (lunarDay % 10 - 1);
            return chineseTen[lunarDay / 10] + CHINESE_NUMBER[n];
        }
    }
