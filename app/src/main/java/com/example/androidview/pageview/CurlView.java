...
public class CurlView extends GLSurfaceView implements View.OnTouchListener,
    ...
    private CurFinishListener mCurFinishListener;
        ...
        if (currentTime >= mAnimationStartTime + mAnimationDurationTime) {
            if (mAnimationTargetEvent == SET_CURL_TO_RIGHT) {
                ...
                if (mCurlState == CURL_LEFT) {
                    --mCurrentIndex;
                    if (mCurFinishListener != null) {
                        mCurFinishListener.curFinish(false);
                    }
                }
                ...
                if (mCurlState == CURL_RIGHT) {
                    ++mCurrentIndex;
                    if (mCurFinishListener != null) {
                        mCurFinishListener.curFinish(true);
                    }
                }
            }
    ...
    public void setCurFinishListener(CurFinishListener listener) {
        mCurFinishListener = listener;
    }
