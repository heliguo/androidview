...
public class CardScaleHelper {
    ...
    public void attachToRecyclerView(final RecyclerView mRecyclerView) {
        ...
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                //求出卡片宽度
                mCardWidth = mRecyclerView.getWidth() - ScreenUtils.dp2px(mContext, 2 * (CardScaleConstant.PAGER_PADDING + CardScaleConstant.PAGER_MARGIN));
