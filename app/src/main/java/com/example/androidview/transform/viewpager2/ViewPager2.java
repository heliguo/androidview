package com.example.androidview.transform.viewpager2;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private com.example.androidview.transform.viewpager2.FakeDrag mFakeDragger;
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        mRecyclerView.setLayoutParams(
                new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        ...
        mFakeDragger = new com.example.androidview.transform.viewpager2.FakeDrag(this, mScrollEventAdapter, mRecyclerView);
