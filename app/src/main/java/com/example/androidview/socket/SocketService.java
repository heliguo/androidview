package com.example.androidview.socket;
...
import com.example.androidview.Constants;
...
//                        msg.setTag(Constants.CONNECT_SUCCESS);
//                        Evet.getDefault().post(msg);
                        /*发送心跳数据*/
                        sendBeatData();
                    }
