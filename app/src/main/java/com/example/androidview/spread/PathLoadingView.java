...
import com.example.androidview.smarttablayout.ScreenUtil;
//    入口   绘制 Path
//组合控件  组合   播放界面
//背景单独组合
//  唱针   唱盘组合
...
public class PathLoadingView extends View {
    ...
    private void init() {
        ...
        //Path
        mPath = new Path();
        mPath.addCircle(ScreenUtil.getScreenWidth(getContext())/2f, ScreenUtil.getScreenHeight(getContext())/2f,
                100f, Path.Direction.CW);//加入一个半径为100圆
